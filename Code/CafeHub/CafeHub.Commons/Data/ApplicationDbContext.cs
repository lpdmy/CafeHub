...
namespace CafeHub.Commons
{
    public class ApplicationDbContext : IdentityDbContext<User>
    {
            ...
            var products = new List<Product>
        {
            ...
            new Product { Id = 17, Name = "Almond Croissant", Price = 22000.00m, Size = "Medium", Description = "A perfect pairing of crispy, freshly made chips and rich, flavorful dips.", CategoryId = 3, ImagePath = "/images/dessert-image-3.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new Product {Id = 18, Name = "Berry Danish", Price = 20000.00m, Size = "Medium", Description = "A light, flaky pastry topped with fresh mixed berries.", CategoryId = 3, ImagePath = "/images/dessert-image-2.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new Product { Id = 19, Name = "Chocolate Eclair", Price = 24000.00m, Size = "Medium", Description = "A classic French pastry filled with creamy custard and chocolate.",  CategoryId = 3, ImagePath = "/images/dessert-image-3.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new Product { Id = 20,Name = "Cinnamon Bun", Price = 30000.00m, Size = "Large", Description = "A warm, soft bun swirled with cinnamon and sugar.", CategoryId = 3, ImagePath = "/images/dessert-image-4.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new Product { Id = 21, Name = "Caramel Brownie", Price = 26000.00m, Size = "Medium", Description = "Rich, fudgy brownies swirled with creamy caramel.", CategoryId = 3, ImagePath = "/images/dessert-image-5.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new Product { Id = 22, Name = "Choco Chip Cookies", Price = 22000.00m, Size = "Small", Description = "Classic soft cookies loaded with gooey chocolate chips.", CategoryId = 3, ImagePath = "/images/dessert-image-6.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new Product { Id = 23,Name = "Lemon Cheesecake", Price = 32000.00m, Size = "Large", Description = "A tangy and creamy cheesecake with zesty lemon flavor.", CategoryId = 3, ImagePath = "/images/dessert-image-7.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow },
            new Product { Id = 24, Name = "Peach Tart", Price = 20000.00m, Size = "Medium", Description = "A crisp tart filled with sweet peach filling.", CategoryId = 3, ImagePath = "/images/dessert-image-8.png", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow }
        };
